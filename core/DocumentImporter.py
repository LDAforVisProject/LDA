    ...
    try:
        ...
        '''
            ...
            Next steps:     
                            ...
                            x Execute tag refinery postprocessing again.
                            x Continue work on DocumentImporter.py; import all documents in the DB.
                                x Refined text used for topic modelling (tagRefineryData.csv)
                                x Original text (as in original, primitive abstract list)
                            * topics_in_documents:
                                x Create topic_in_document table (how to access: http://stackoverflow.com/questions/25803267/retrieve-topic-word-array-document-topic-array-from-lda-gensim); 
